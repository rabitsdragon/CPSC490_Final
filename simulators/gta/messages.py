...
class Formal_Config:
    def __init__(
        self, location=None, time=None, weather=None, vehicles=None, view_heading=None
    ):
...
class Scenario:
    def __init__(
        self, location=None, time=None, weather=None, vehicle=None, drivingMode=None
    ):
...
def frame2numpy(frame, frameSize):
    ...
    return as_strided(
        buff, strides=(strideWidth, 3, 1), shape=(frameSize[1], frameSize[0], 3)
    ).copy()
